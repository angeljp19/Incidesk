...
export function SolicitudHistorialPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        if (t.tecnico_asignado_id !== userObj.id) {
        ...
        navigate("/techUser/historialSolicitudes");
      }
    };
  ...
  return (
    <div className="flex flex-col md:flex-row gap-6 lg:p-5 w-full h-full overflow-auto ">
      ...
      <div className="bg-white shadow-lg rounded-2xl p-6 space-y-6 no-scrollbar w-full lg:w-1/3">
        {/* HEADER */}
      ...
      ${
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar bg-[#F5F7FB] rounded-xl p-4 space-y-3 max-h-[50svh] lg:max-h-screen">
          {vistaComentarios === "publico"
